...
<asp:Content ID="bc" ContentPlaceHolderID="bodyContent" runat="server">
        ...
        <h4 class="ch4"><img src="img/search.png" alt="Pulpit rock" width="64" height="64">Lütfen Gerekli İş Bilgileri Girin</h4>  
        <hr width=”100%” color=”#0000F8” size=5>
    
      <form role="form">
  <div class="form-group">
    <label class="text-primary"><img src="img/title.png" alt="Pulpit rock" width="32" height="32">Yapılmak İstenen İş</label>
    <input type="text" class="form-control" id="InputTitle" placeholder="Yapılmak istenen iş...">
  </div>
  <div class="form-group">
    <label class="text-primary"><img src="img/detail.png" alt="Pulpit rock" width="32" height="32">İşin Detayı</label>
  ...
  <form role="form">
  <div class="form-group">
    <label class="text-primary"><img src="img/location.png" alt="Pulpit rock" width="32" height="32">Nerede yapılacak ?</label>
    <input type="text" class="form-control" id="Inputlocation" placeholder="Nerede yapılsın...">
  </div>
          </form>
  <label class="text-primary"><img src="img/date.png" alt="Pulpit rock" width="32" height="32">İşin Teslim Tarihi</label>
        ...
        <div class="form-group">
            <input id="datepicker" type="text" class="form-control" placeholder="Tarih Seçin" required />
                   ...
                   <form role="form">
  <div class="form-group">
    <label class="text-primary"><img src="img/money.png" alt="Pulpit rock" width="32" height="32">Ücret ?</label>
