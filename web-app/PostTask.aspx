...
<asp:Content ID="bc" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <h4 class="ch4">
        <img src="img/search.ico" alt="Pulpit rock" width="64" height="64">Lütfen Gerekli İş Bilgileri Girin</h4>
    ...
    <form role="form">
        <div class="form-group">
            <label class="text-primary">
                <img src="img/title.ico" alt="Pulpit rock" width="32" height="32">Yapılmak İstenen İş</label>
            <input type="text" class="form-control" id="InputTitle" placeholder="Yapılmak istenen iş...">
        </div>
        <div class="form-group">
            <label class="text-primary">
                <img src="img/detail.ico" alt="Pulpit rock" width="32" height="32">İşin Detayı</label>
    ...
    <div class="btn-group dropup">
        <form role="form">
            <div class="form-group">
                <label class="text-primary">
                    <img src="img/location.ico" alt="Pulpit rock" width="32" height="32">Nerede yapılacak ?</label>
                <input type="text" class="form-control" id="Inputlocation" placeholder="Nerede yapılsın...">
            </div>
        </form>
        <label class="text-primary">
            <img src="img/date.ico" alt="Pulpit rock" width="32" height="32">İşin Teslim Tarihi</label>
        ...
        <form role="form">
            <div class="form-group">
                <label class="text-primary">
                    <img src="img/money.ico" alt="Pulpit rock" width="32" height="32">Ücret ?</label>
