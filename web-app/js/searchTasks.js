        ...
        for (var i = 0; i < array.length; i++) {
            ...
            for (var index in array[i]) {
                ...
                if (array[i][index] == null) {
                    ...
                    if (index === 'UserID') {
                        //test
                        str += '<hr><div class="result-avatar" style="float:left; margin-right:10px; "><img alt src="Image.ashx?id=' + array[i]['UserID'] + '" id="imgProfile" class="img-rounded" style="width:50px; height:50px;"> </div>';
                    }
