...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div id="TaskDetailsContent">
        <div class="firstbehind">
            ...
            <div><p class="navbar-text" style="background-color:#C8C8C8; float:none; width:400px; margin-right:auto;"><span style="color:#fff; font-size:14px; font-weight:bold; margin-left:10px;">İşin Detayı</span></p></div>
