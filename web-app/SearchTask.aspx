...
<asp:Content ID="bc" ContentPlaceHolderID="bodyContent" runat="server">
  ...
  <div class="form-group">
    <input type="text" class="form-control" style="width:500px; margin-right:10px; float:left;" placeholder="Aranacak anahtar kelimeyi giriniz...">
      <button type="submit" style="width:100px;" class="btn btn-success">Ara</button>
  </div>  
</form>
